...
{
  "$end", "error", "$undefined", "NUM", "POWER", "'+'", "'-'", "'*'",
  "'/'", "'('", "')'", "$accept", "s", "s1", "e", "e1", "t", "t1", "f", YY_NULLPTR
};
#endif
...
{
      -1,   -11,    -1,    11,    -3,     0,    -4,     8,   -11,    -1,
     -11,    -1,    -1,   -11,    -1,    -1,   -11,   -11,    -3,     0,
       0,    -4,    -4,   -11,   -11,   -11,   -11,   -11
};
...
{
       0,    14,     0,     0,     4,     8,    12,     0,     1,     0,
       2,     0,     0,     5,     0,     0,     9,    13,     4,     8,
       8,    12,    12,     3,     6,     7,    10,    11
};
...
{
       7,     9,     1,    14,    15,    11,    12,    18,     2,    24,
      25,     8,    19,    20,    26,    27,    21,    22,    17,     0,
       0,    23
};

static const yytype_int8 yycheck[] =
{
       2,     4,     3,     7,     8,     5,     6,     9,     9,    19,
      20,     0,    11,    12,    21,    22,    14,    15,    10,    -1,
      -1,    18
};
...
{
       0,     3,     9,    12,    14,    16,    18,    14,     0,     4,
      13,     5,     6,    15,     7,     8,    17,    10,    14,    16,
      16,    18,    18,    13,    15,    15,    17,    17
};
