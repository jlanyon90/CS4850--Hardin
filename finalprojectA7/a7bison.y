...
lines: 
     | lines statement
;
statement: iexpr ENDOFLINE{ printf("Result -> %d\n", $1);  } 
...
ifstate: IF_TOKEN LPARENT compare RPARENT{	
											mystate = $1;
											mystate.outcome = $3;
											begin("skip");
										 }
...
ins: IFINS {strcat(mystate.instruct[strlen(mystate.instruct)+1],$1);}
	|ENDIF_TOKEN {if(mystate.outcome == "TRUE") yylex(mystate.instruct); 
					begin2();
}
